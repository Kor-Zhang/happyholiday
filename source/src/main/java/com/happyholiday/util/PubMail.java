...
public class PubMail {
	...
	public PubMail() {
		try {
			...
			PubStatic.log.info("链接邮箱" + username + "成功！");
			...
			PubStatic.log.error("Mail#loadProperties方法错误");
			e.printStackTrace();
		}
	...
	public  void sendMessage(String subject, String content) throws MessagingException {
		...
		PubStatic.log.info(this.to);
		PubStatic.log.info(subject);
		PubStatic.log.info(content);
		Transport.send(mime);
		PubStatic.log.info("发给"+this.to+"的信息成功！");
	...
	public static void main(String[] args) {
		try {
			new PubMail().sendMessage("1113413647@qq.com","幸福假日官网", "您好!");
		} catch (MessagingException e) {
			e.printStackTrace();
		}
	}
