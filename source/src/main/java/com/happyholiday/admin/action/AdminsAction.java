...
import com.happyholiday.admin.exception.AdminsIsLoginException;
...
results = { @Result(name = "adminLogoff_success",type="redirect",location = "/admins/index.jsp") })
public class AdminsAction extends AdminsBaseAction implements ModelDriven<PageAdmins> {

	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(AdminsAction.class);
	...
	public void adminLogin() {
		...
		try {
			...
			//在app中设置在线状态
			BackStatic.log.info(adminsSessionMap.getValues().size());
			
			//查看该用户是否已经登陆
			String onlineAdminId = objAdmin.getId();
			BackStatic.log.info(adminsSessionMap.containKey(onlineAdminId));
