...
<table id="admins_yhglrz_checkuserdialog_datagrid">
...
<script type="text/javascript">
	var yhglrzUserDatagrid = undefined;
	$(function($) {
		$('#admins_yhglrz_checkuserdialog_datagrid').datagrid({
			
			url :'${pageContext.request.contextPath}/usersAction!getSingleUserDatagridById.action?id='+yhdlrzCheckUserId,
			idField:'id',
			fit:true,
			border:false,
			sortName:'id',
