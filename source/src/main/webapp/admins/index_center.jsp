					...
					<div region="north" width="100%" height="50%" split="true"
						...
						<div id="about" class="easyui-panel" title="关于" fit="true"
							...
							<table>
								...
								<tr>
									<td>
										<p>幸福假日后台管理是一个对幸福假日数据管理的后台系统。</p>
									</td>
								</tr>
								<tr>
									<td>
										<p>该后台系统涵盖的功能包括：租车业务，酒店业务，权限管理等。</p>
									</td>
								</tr>
							</table>
						</div>
					...
					<div region="south" width="100%" height="50%" split="true"
						...
						<div id="link" class="easyui-panel" title="链接" fit="true"
							...
							<table>
								...
								<tr>
									<td>
										<p>----------------<a target="blank" href="<c:url value='/index.jsp'/>">幸福假日首页</a></p>
									</td>
								</tr>
								<tr>
									<td>
										<p>----------------<a target="blank" href="<c:url value='/index.jsp'/>">租车模块首页</a></p>
									</td>
								</tr>
								<tr>
									<td>
										<p>----------------<a target="blank" href="<c:url value='/index.jsp'/>">酒店模块首页</a></p>
									</td>
								</tr>
								<tr>
									<td>
										<p>----------------<a target="blank" href="<c:url value='/officialwebsite/index.jsp'/>">幸福假日官网</a></p>
									</td>
								</tr>
							</table>
						</div>
					...
					<div region="north" width="100%" height="50%" split="true"
						...
						<div id="explain" class="easyui-panel" title="说明" fit="true"
							...
							<table>
								...
								<tr>
									<td>
										<p>请所有管理员遵守<a style="color:red;" href="javascript:showRule();">幸福假日管理准则</a>。</p>
									</td>
								</tr>
							</table>
						</div>
...
<script type="text/javascript">
	...
	function showRule(){
		...
		$('<div/>').dialog({
			...
			border:false,
			maximizable:true,
			href:'${pageContext.request.contextPath}/admins/glzz.jsp',
			onClose:function(){
				//删除以前的节点
				$(this).dialog('destroy');
			},
	...
	*/
	function linkServletSetNotices(){
		zkAjax("/noticesAction!getNoticesList.action?order=desc&sort=createTime",function(data){
			//清空公告
			noticeTable.html('');
			var rows = data.rows;
