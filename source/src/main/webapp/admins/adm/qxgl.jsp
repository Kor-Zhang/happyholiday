...
<script type="text/javascript">
	...
	$(function($) {
		qxglDatagrid = $('#admins_qxgl_datagrid').datagrid({
			...
			url :'${pageContext.request.contextPath}/adminsAction!getDatagrid.action',
			pagination:true,
			fit:true,
			idField:'id',
			sortName:'createTime',
	...
	**/
	function add(){
		...
		addDialog = $('<div/>').dialog({
			...
			height:250,
			modal:true,
			href:'${pageContext.request.contextPath}/admins/adm/qxgl_adddialog.jsp',
			onClose:function(){
				//删除以前的节点
				$(this).dialog('destroy');
				addDialog = undefined;
	...
	function edit(){
		...
		if(checkedRow.length==1){
			...
			editDialog = $('<div/>').dialog({
				...
				height:180,
				modal:true,
				href:'${pageContext.request.contextPath}/admins/adm/qxgl_editdialog.jsp',
				onClose:function(){
					//删除以前的节点
					$(this).dialog('destroy');
	...
	function editPwd(){
		...
		if(checkedRow.length==1){
			...
			editPwdDialog = $('<div/>').dialog({
				...
				height:100,
				modal:true,
				href:'${pageContext.request.contextPath}/admins/adm/qxgl_editpwddialog.jsp',
				onClose:function(){
					//删除以前的节点
					$(this).dialog('destroy');
	...
	*/
	function managePower(adminId){
		...
		managePowerDialog = $('<div/>').dialog({
			...
			maximizable:true,
			modal:true,
			href:'${pageContext.request.contextPath}/admins/adm/qxgl_managepowerdialog.jsp',
			onClose:function(){
				//删除以前的节点
				$(this).dialog('destroy');
