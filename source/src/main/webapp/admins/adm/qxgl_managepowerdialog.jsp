	...
	<div data-options="region:'south'" style="height:30px;">
		<a class="easyui-linkbutton" 
			...
			onClick:function(){
				...
				zkAjax('/powersAction!updatePowers.action?adminId='+managePowerAdminId+'&checkedId='+checkedId,function(data){
...
<script type="text/javascript">
	...
	//加载树
	zkAjax('/powersAction!getPowerTree.action?adminId='+managePowerAdminId,function(data){
		showMsg(data);
		try{
			isOnline(data);
