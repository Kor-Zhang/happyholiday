...
<script type="text/javascript"
	src="<c:url value='/jslib/jquery-easyui-1.4.1/extension/etree/jquery.etree.js'/>"></script>
<script type="text/javascript"
	src="<c:url value='/jslib/jquery-easyui-1.4.1/extension/etree/jquery.etree.lang.js'/>"></script>
...
<script type="text/javascript">
	...
	var checkViewTicketDialog = undefined;
	var currentCheckViewTicketId  = undefined;
	...
	$(function($){
		...
		$('#admins_index_indexEast').panel({
			fit:true,
			border:false,
			href:'${pageContext.request.contextPath}/admins/index_east.jsp'
		});
		//加载西部模块
		$('#admins_index_indexWest').panel({
			fit:true,
			border:false,
			href:'${pageContext.request.contextPath}/admins/index_west.jsp'
		});
		//加载北部模块
		$('#admins_index_indexNorth').panel({
			fit:true,
			border:false,
			href:'${pageContext.request.contextPath}/admins/index_north.jsp'
		});
		...
		$('#admins_index_indexSouth').panel({
			fit:true,
			border:false,
			href:'${pageContext.request.contextPath}/admins/index_south.jsp'
		});
		//加载中部模块
		$('#admins_index_indexCenter').panel({
			fit:true,
			border:false,
			href:'${pageContext.request.contextPath}/admins/index_center.jsp'
		});
		...
		loginDialog = $('<div/>').dialog({
			...
			height:150,
			border:false,
			href:'${pageContext.request.contextPath}/admins/login.jsp',
			onLoad:function(){
	...
	**/
	...
	function updateThemes(newThemeString) {
		...
		zkAjax("/adminsAction!updateTheme.action?theme="+newThemeString,function(data){
	...
	*/
	function checkUser(userId){
		...
		checkUserDialog = $('<div/>').dialog({
			...
			maximizable:true,
			modal:true,
			href:'${pageContext.request.contextPath}/admins/checkuserdialog.jsp',
			onClose:function(){
				//删除以前的节点
				$(this).dialog('destroy');
	...
	*/
	function checkAdmin(adminId){
		...
		checkAdminDialog = $('<div/>').dialog({
			...
			height:200,
			modal:true,
			href:'${pageContext.request.contextPath}/admins/checkadmindialog.jsp',
			onClose:function(){
				//删除以前的节点
				$(this).dialog('destroy');
	...
	*/
	function checkNotice(noticeId){
		...
		checkNoticeDialog = $('<div/>').dialog({
			...
			height:400,
			modal:true,
			href:'${pageContext.request.contextPath}/admins/checknoticedialog.jsp',
			onClose:function(){
				//删除以前的节点
				$(this).dialog('destroy');
	...
	*/
	function checkCar(carId){
		...
		checkCarDialog = $('<div/>').dialog({
			...
			height:200,
			modal:true,
			href:'${pageContext.request.contextPath}/admins/checkcardialog.jsp',
			onClose:function(){
				//删除以前的节点
				$(this).dialog('destroy');
	...
	*/
	function checkCarImg(carId){
		...
		checkCarImgsDialog = $('<div/>').dialog({
			...
			height:400,
			modal:true,
			href:'${pageContext.request.contextPath}/admins/checkcarimgdialog.jsp',
			onClose:function(){
				//删除以前的节点
				$(this).dialog('destroy');
	...
	*/
	function checkAdminPower(adminId){
		...
		checkPowerAdminDialog = $('<div/>').dialog({
			...
			maximizable:true,
			modal:true,
			href:'${pageContext.request.contextPath}/admins/checkadminpowerdialog.jsp',
			onClose:function(){
				//删除以前的节点
				$(this).dialog('destroy');
	...
	/****************景点门票的 所有查看窗口 by xiaocheng 2016/10/14*******************/
	/**
	* 查看景区
	*/
	function checkView(id){
		...
		//添加节点
			checkViewDialog = $('<div/>').dialog({
				...
				height:200,
				modal:true,
				href:'${pageContext.request.contextPath}/admins/viewticket/viewticket_checkView.jsp',
				onClose:function(){
					//删除以前的节点
					$(this).dialog('destroy');
		...
		* 查看景区图片
		*/
		function checkViewImg(id){
			currentCheckViewId = id;
			checkViewImgDialog = $('<div/>').dialog({
				title:'景区图片信息',
				width:500,
				height:450,
				modal:true,
				href:'${pageContext.request.contextPath}/admins/viewticket/viewticket_checkViewImg.jsp',
				onClose:function(){
					//删除以前的节点
					$(this).dialog('destroy');
					checkViewImgDialog = undefined;
				},
				onOpen:function(){
				},
				onLoad:function(){
	...
	function checkViewTicket(id){
			currentCheckViewTicketId = id;
			checkViewTicketDialog = $('<div/>').dialog({
				title:'景区门票信息',
				width:700,
				height:200,
				modal:true,
				href:'${pageContext.request.contextPath}/admins/viewticket/viewticket_checkViewTicket.jsp',
				onClose:function(){
					//删除以前的节点
					$(this).dialog('destroy');
					checkViewImgDialog = undefined;
