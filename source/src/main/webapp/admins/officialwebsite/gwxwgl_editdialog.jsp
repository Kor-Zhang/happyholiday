...
<form id="admins_gwxwgl_editdialog_editForm"  method="post" action="" enctype="multipart/form-data">
	...
	<a class="easyui-linkbutton"
		...
		onClick:function(){
			$('#admins_gwxwgl_editdialog_editForm').form('submit',{
				url:'${pageContext.request.contextPath}'+owBackNamespace+'/owNewsBackAction!updateTextNews.action',
...
<script type="text/javascript" charset="utf-8">
	...
	editor = KindEditor.create('textarea[name="text"]', {
		...
		uploadJson : '${pageContext.request.contextPath}' + owBackNamespace
				+ '/owNewsUploadBackAction!uploadNewsTextImg.action',
