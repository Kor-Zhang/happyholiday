...
<form id="admins_gwcygl_editdialog_editForm"  method="post" action="" enctype="multipart/form-data">
	...
	<a class="easyui-linkbutton"
		...
		onClick:function(){
			gwcyglEditForm.form('submit',{
				url:'${pageContext.request.contextPath}'+owBackNamespace+'/owMembersUpdateBackAction!updateMembers.action',
