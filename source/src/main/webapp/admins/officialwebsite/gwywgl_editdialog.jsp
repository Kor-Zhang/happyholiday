...
<form id="admins_gwywgl_editdialog_editForm"  method="post" action="" enctype="multipart/form-data">
	...
	<a class="easyui-linkbutton"
		...
		onClick:function(){
			$('#admins_gwywgl_editdialog_editForm').form('submit',{
				url:'${pageContext.request.contextPath}'+owBackNamespace+'/owServiceBackAction!updateTextService.action',
