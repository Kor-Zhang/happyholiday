...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'west',border:false" style="width:200px;">
		<div style="float:left;width:100%;">
			<span style="color:rgb(6,167,255);font-size: 35px;">幸福</span> <span
				style="color:red;font-size: 29px;">假日</span>
		</div>
	</div>
		...
		<div>
			...
			<div id="admins_index_settingMenu" style="width:120px;">
				...
				<div data-options="iconCls:'icon-remove'"
					...
					<a
						href="${pageContext.request.contextPath}/adminsAction!adminLogoff.action"
