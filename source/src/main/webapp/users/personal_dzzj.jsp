  ...
  <body>
		<div class="myContent" id="content">
			...
			<div class="myContent_Status">
				...
				<a  target="f2" onclick="selectStatus(this)" class="btn btn-default">预定成功</a>
				<a  target="f2" onclick="selectStatus(this)" class="btn btn-default">租赁中</a>	
			...
			<div class="myContent_Order"> 
				<iframe width="100%"  src='<c:url value='/users/personal_order.jsp'/>' id="iframepage" heigth="100%" scrolling="no" frameborder="0"  marginheight="0" marginwidth="0" name="f1" >
				</iframe>
				<!--分页条 开始-->
...
<script type="text/javascript"
	...
	<script type="text/javascript" src="<c:url value='/jslib/users/personal_dzzj.js'/>"></script>
