  ...
  <body>
		...
		<div class="container">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form id="frmPwd" method="post" action="${pageContext.request.contextPath}/frontUsersAction!forgetPwd.action">
						<div class="form-group row">
							<div class="input-group">
								<div class="input-group-addon">
									<i class="glyphicon glyphicon-phone"></i>
								</div>
								<input type="text" class="form-control" value="${requestScope.Fphone} " name="phone" id="phone" maxlength="11"  placeholder="请输入您的手机号" autocomplete="off" />
							</div>
							<div class="Tip" id="phone_Tips">${sessionScope.forgetPwd}</div>
							<div class="input-group">
								<div class="input-group-addon">
							...
							<div class="Tip" id="password_Tips3">${requestScope.msg}</div>
							<div class="input-group">
    ...
    <div class="bottom">
         <div class="bottom-content">
             <div class="content1">
                	<a target="_blank" href="<c:url value='/officialwebsite/index.jsp'/>">关于我们</a><span>丨</span>
